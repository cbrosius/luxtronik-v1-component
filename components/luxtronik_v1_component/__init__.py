...
CONFIG_SCHEMA = (
    cv.Schema({
        ...
        cv.Optional(CONF_DURCHSCHNITTLICHE_VERDICHTER_EINSCHALTDAUER_1): OPERATINGHOURS_SENSOR_SCHEMA,
        ...
        cv.Optional(CONF_DURCHSCHNITTLICHE_VERDICHTER_EINSCHALTDAUER_2): OPERATINGHOURS_SENSOR_SCHEMA,
