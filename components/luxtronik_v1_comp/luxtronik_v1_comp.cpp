...
void LuxtronikV1Component::parse_inputs_(const std::string &message) {
  std::vector<sensor::Sensor*> sensors = {
...
void LuxtronikV1Component::parse_outputs_(const std::string &message) {
  std::vector<sensor::Sensor*> sensors = {
...
void LuxtronikV1Component::parse_status_(const std::string &message) {
  std::vector<sensor::Sensor*> sensors = {
...
void LuxtronikV1Component::parse_heating_mode_(const std::string &message) {
  std::vector<sensor::Sensor*> sensors = { modus_Heizung_ptr };
  parse_message_(message, sensors, 5);
}

void LuxtronikV1Component::parse_water_mode_(const std::string &message) {
...
void LuxtronikV1Component::set_temp_RL_Soll(sensor::Sensor* temp_RL_Soll) {
    this->temp_RL_Soll_ptr = temp_RL_Soll;
  }
void LuxtronikV1Component::set_temp_Heissgas(sensor::Sensor* temp_Heissgas) {
    this->temp_Heissgas_ptr = temp_Heissgas;
  }
void LuxtronikV1Component::set_temp_Aussen(sensor::Sensor* temp_Aussen) {
    this->temp_Aussen_ptr = temp_Aussen;
  }
void LuxtronikV1Component::set_temp_BW(sensor::Sensor* temp_BW) {
    this->temp_BW_ptr = temp_BW;
  }
void LuxtronikV1Component::set_temp_BW_Soll(sensor::Sensor* temp_BW_Soll) {
    this->temp_BW_Soll_ptr = temp_BW_Soll;
  }
void LuxtronikV1Component::set_temp_WQ_Ein(sensor::Sensor* temp_WQ_Ein) {
    this->temp_WQ_Ein_ptr = temp_WQ_Ein;
  }
void LuxtronikV1Component::set_temp_Kaeltekreis(sensor::Sensor* temp_Kaeltekreis) {
    this->temp_Kaeltekreis_ptr = temp_Kaeltekreis;
  }
void LuxtronikV1Component::set_temp_MK1_Vorl(sensor::Sensor* temp_MK1_Vorl) {
    this->temp_MK1_Vorl_ptr = temp_MK1_Vorl;
  }
void LuxtronikV1Component::set_temp_MK1VL_Soll(sensor::Sensor* temp_MK1VL_Soll) {
    this->temp_MK1VL_Soll_ptr = temp_MK1VL_Soll;
  }
void LuxtronikV1Component::set_temp_Raumstat(sensor::Sensor* temp_Raumstat) {
    this->temp_Raumstat_ptr = temp_Raumstat;
  }
void LuxtronikV1Component::set_ein_Abtau_Soledruck_Durchfluss(sensor::Sensor* ein_Abtau_Soledruck_Durchfluss) {
    this->ein_Abtau_Soledruck_Durchfluss_ptr = ein_Abtau_Soledruck_Durchfluss;
  }
void LuxtronikV1Component::set_ein_Sperrzeit_EVU(sensor::Sensor* ein_Sperrzeit_EVU) {
    this->ein_Sperrzeit_EVU_ptr = ein_Sperrzeit_EVU;
  }
void LuxtronikV1Component::set_ein_Hochdruckpressostat(sensor::Sensor* ein_Hochdruckpressostat) {
    this->ein_Hochdruckpressostat_ptr = ein_Hochdruckpressostat;
  }
void LuxtronikV1Component::set_ein_Motorschutz(sensor::Sensor* ein_Motorschutz) {
    this->ein_Motorschutz_ptr = ein_Motorschutz;
  }
void LuxtronikV1Component::set_ein_Niederdruckpressostat(sensor::Sensor* ein_Niederdruckpressostat) {
    this->ein_Niederdruckpressostat_ptr = ein_Niederdruckpressostat;
  }
void LuxtronikV1Component::set_ein_Fremdstromanode(sensor::Sensor* ein_Fremdstromanode) {
    this->ein_Fremdstromanode_ptr = ein_Fremdstromanode;
  }
void LuxtronikV1Component::set_aus_ATV(sensor::Sensor* aus_ATV) {
    this->aus_ATV_ptr = aus_ATV;
  }
void LuxtronikV1Component::set_aus_BWP(sensor::Sensor* aus_BWP) {
    this->aus_BWP_ptr = aus_BWP;
  }
void LuxtronikV1Component::set_aus_FBHP(sensor::Sensor* aus_FBHP) {
    this->aus_FBHP_ptr = aus_FBHP;
  }
void LuxtronikV1Component::set_aus_HZP(sensor::Sensor* aus_HZP) {
    this->aus_HZP_ptr = aus_HZP;
  }
void LuxtronikV1Component::set_aus_Mischer_1_Auf(sensor::Sensor* aus_Mischer_1_Auf) {
    this->aus_Mischer_1_Auf_ptr = aus_Mischer_1_Auf;
  }
void LuxtronikV1Component::set_aus_Mischer_1_Zu(sensor::Sensor* aus_Mischer_1_Zu) {
    this->aus_Mischer_1_Zu_ptr = aus_Mischer_1_Zu;
  }
void LuxtronikV1Component::set_aus_VentWP(sensor::Sensor* aus_VentWP) {
    this->aus_VentWP_ptr = aus_VentWP;
  }
void LuxtronikV1Component::set_aus_VentBrunnen(sensor::Sensor* aus_VentBrunnen) {
    this->aus_VentBrunnen_ptr = aus_VentBrunnen;
  }
void LuxtronikV1Component::set_aus_Verdichter_1(sensor::Sensor* aus_Verdichter_1) {
    this->aus_Verdichter_1_ptr = aus_Verdichter_1;
  }
void LuxtronikV1Component::set_aus_Verdichter_2(sensor::Sensor* aus_Verdichter_2) {
    this->aus_Verdichter_2_ptr = aus_Verdichter_2;
  }
void LuxtronikV1Component::set_aus_ZPumpe(sensor::Sensor* aus_ZPumpe) {
    this->aus_ZPumpe_ptr = aus_ZPumpe;
  }
void LuxtronikV1Component::set_aus_ZWE(sensor::Sensor* aus_ZWE) {
    this->aus_ZWE_ptr = aus_ZWE;
  }
void LuxtronikV1Component::set_aus_ZWE_Stoerung(sensor::Sensor* aus_ZWE_Stoerung) {
    this->aus_ZWE_Stoerung_ptr = aus_ZWE_Stoerung;
  }
void LuxtronikV1Component::set_status_Anlagentyp(sensor::Sensor* status_Anlagentyp) {
    this->status_Anlagentyp_ptr = status_Anlagentyp;
  }
void LuxtronikV1Component::set_status_Softwareversion(sensor::Sensor* status_Softwareversion) {
    this->status_Softwareversion_ptr = status_Softwareversion;
  }
void LuxtronikV1Component::set_status_Bivalenzstufe(sensor::Sensor* status_Bivalenzstufe) {
    this->status_Bivalenzstufe_ptr = status_Bivalenzstufe;
  }
void LuxtronikV1Component::set_status_Betriebszustand(sensor::Sensor* status_Betriebszustand) {
    this->status_Betriebszustand_ptr = status_Betriebszustand;
  }
void LuxtronikV1Component::set_modus_Heizung(sensor::Sensor* modus_Heizung) {
    this->modus_Heizung_ptr = modus_Heizung;
  }
void LuxtronikV1Component::set_modus_Warmwasser(sensor::Sensor* modus_Warmwasser) {
