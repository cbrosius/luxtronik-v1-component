...
def luxtronik_v1_comp_schema(is_binary=False, unit=UNIT_EMPTY, device_class=DEVICE_CLASS_EMPTY, state_class=STATE_CLASS_NONE):
    if is_binary:
...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_TEMP_VL): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_TEMP_RL): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_TEMP_RL_SOLL): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_TEMP_HEISSGAS): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_TEMP_AUSSEN): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_TEMP_BW): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_TEMP_BW_SOLL): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_TEMP_WQ_EIN): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_TEMP_KAELTEKREIS): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_TEMP_MK1_VORL): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_TEMP_MK1VL_SOLL): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_TEMP_RAUMSTAT): luxtronik_v1_comp_schema(unit=UNIT_CELSIUS, device_class=DEVICE_CLASS_TEMPERATURE, state_class=STATE_CLASS_MEASUREMENT),
        cv.Optional(CONF_EIN_ABTAU_SOLEDRUCK_DURCHFLUSS): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_EIN_SPERRZEIT_EVU): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_EIN_HOCHDRUCKPRESSOSTAT): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_EIN_MOTORSCHUTZ): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_EIN_NIEDERDRUCKPRESSOSTAT): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_EIN_FREMDSTROANODE): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_ATV): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_BWP): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_FBHP): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_HZP): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_MISCHER_1_AUF): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_MISCHER_1_ZU): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_VENTWP): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_VENTBRUNNEN): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_VERDICHTER_1): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_VERDICHTER_2): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_ZPUMPE): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_ZWE): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_AUS_ZWE_STOERUNG): luxtronik_v1_comp_schema(is_binary=True),
        cv.Optional(CONF_STATUS_ANLAGENTYP): luxtronik_v1_comp_schema(),
        cv.Optional(CONF_STATUS_SOFTWAREVERSION): luxtronik_v1_comp_schema(),
        cv.Optional(CONF_STATUS_BIVALENZSTUFE): luxtronik_v1_comp_schema(),
        cv.Optional(CONF_STATUS_BETRIEBSZUSTAND): luxtronik_v1_comp_schema(),
        cv.Optional(CONF_MODUS_HEIZUNG): luxtronik_v1_comp_schema(),
        cv.Optional(CONF_MODUS_WARMWASSER): luxtronik_v1_comp_schema(),
    }
